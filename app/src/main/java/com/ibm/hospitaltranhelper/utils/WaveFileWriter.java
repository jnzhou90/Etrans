...
public class WaveFileWriter {
	...
	public static void init(int sampleRate, int byteRate) {
		...
		SamplesPerSec = revers(intToBytes(sampleRate));
		AvgBytesPerSec = revers(intToBytes(byteRate));
...
//			reversed[i] = tmp[i];
	...
	public int write(int[] samples, int sampleRate, int byteRate, File out) throws IOException {
