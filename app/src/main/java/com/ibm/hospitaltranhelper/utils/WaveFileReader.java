...
public class WaveFileReader {
	...
	public WaveFileReader(String filename, boolean readHeader, long datalength) {

		this.initReader(filename, readHeader, datalength);
	}
	// 判断是否创建wav读取器成功
	...
	private void initReader(String filename, boolean readHeader, long datalength){
...
//				this.chunksize = readLong();
				readLong();
				this.chunksize = datalength + 78 -8;
